...
public class MultipleAxesLineChart extends StackPane {
    ...
    private final double xAxisWidth = 60;
    private final AnchorPane detailsWindow;

    private final double xAxisSeparation = 20;
    ...
    private void setFixedAxisWidth(LineChart chart) {
        chart.getYAxis().setPrefWidth(xAxisWidth);
        chart.getYAxis().setMaxWidth(xAxisWidth);
    }
...
//
//        lineChart.minWidthProperty().bind(widthProperty().subtract((xAxisWidth + xAxisSeparation) * backgroundCharts.size()));
//        lineChart.prefWidthProperty().bind(widthProperty().subtract((xAxisWidth + xAxisSeparation) * backgroundCharts.size()));
//        lineChart.maxWidthProperty().bind(widthProperty().subtract((xAxisWidth + xAxisSeparation) * backgroundCharts.size()));
//
//        return lineChart;
...
//        yAxis.setTickLabelFill(lineColor);
//        // create chart
