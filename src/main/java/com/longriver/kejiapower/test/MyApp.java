    ...
    protected Task<Number> createTask() {
        ...
        Task<Number> task=new Task<Number>() {
            ...
            protected Number call() throws Exception {
                ...
                FileInputStream fis=new FileInputStream(new File("D:\\Download\\CAJViewer 7.3.133.self.exe"));
                FileOutputStream fos=new FileOutputStream(new File("D:\\Download\\CAJViewer 7.3.133.copy.exe"));
                //获取字节长
